...
public class ExecHeader {
    ...
    public static String[] getHeader(Connection conn, String sq) {
        String[] header = getHeader(conn, sq, DEFAULT_MAX_ROWS, DEFAULT_MAX_TEXT_COL_WIDTH);
        return header;
    }

    public static void getHeader(Connection conn, String sq, int maxRows) {
        getHeader(conn, sq, maxRows, DEFAULT_MAX_TEXT_COL_WIDTH);
    }

    public static String[] getHeader(Connection conn, String sq, int maxRows, int maxStringColWidth) {
        String[] header = null;
        if (conn == null) {
